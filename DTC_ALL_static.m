function [residual, g1, g2] = DTC_ALL_static(y, x, params)
%
...
T26 = T23/T18+1/(1+y(4));
T72 = params(2)*getPowerDeriv(y(2),(-params(1)),1);
lhs =y(1);
rhs =y(1)/(1+y(4));
residual(1)= lhs-rhs;
lhs =y(2)^(-params(1));
...
if nargout >= 2,
  ...
  g1(2,2)=getPowerDeriv(y(2),(-params(1)),1)-(T26*T72+T18*(-(T23*T72))/(T18*T18));
