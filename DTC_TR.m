...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('DTC_TR_static');
erase_compiled_function('DTC_TR_dynamic');
...
if exist('estim_params_', 'var') == 1
  save('DTC_TR_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DTC_TR_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DTC_TR_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DTC_TR_results.mat', 'estimation_info', '-append');
end
