...
options_ = [];
M_.fname = 'DTC_baseline';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('DTC_baseline.log');
M_.exo_names = 'e_ee';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('DTC_baseline_static');
erase_compiled_function('DTC_baseline_dynamic');
...
save('DTC_baseline_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('DTC_baseline_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DTC_baseline_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DTC_baseline_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DTC_baseline_results.mat', 'estimation_info', '-append');
end
