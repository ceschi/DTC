...
T63 = (1-params(4))/mbar__^2;
T69 = params(2)*flex__^(-params(1))*mbar__^(1-params(4));
lhs =y(4);
rhs =y(1)-y(12);
residual(1)= lhs-rhs;
lhs =y(5);
rhs =(1-params(4))/params(1)*y(6)+y(11)+y(12)*1/params(1)+x(it_, 1);
residual(2)= lhs-rhs;
residual(3) = y(6)*T63+T69*y(8)-(1-params(11))*(y(1)+dbar__*(y(1)-y(6)));
lhs =y(7);
rhs =params(2)*y(12)+kappa__*(y(5)-flex__*y(9))+x(it_, 2);
residual(4)= lhs-rhs;
lhs =y(8);
rhs =y(12)*params(3)+y(10);
residual(5)= lhs-rhs;
lhs =y(9);
